    ...
    fn try_from_reader(reader: StructReader) -> Result<Self> {
        let value = Field_0 {
            ...
            annotations: reader
                .read_pointer(1u32)?
                .into_list_reader()?
                .read_struct_children::<Annotation>()?,
    ...
    fn try_from_reader(reader: StructReader) -> Result<Self> {
        let value = Node_0 {
            ...
            nested_nodes: reader
                .read_pointer(1u32)?
                .into_list_reader()?
                .read_struct_children::<Node__NestedNode>()?,
            annotations: reader
                .read_pointer(2u32)?
                .into_list_reader()?
                .read_struct_children::<Annotation>()?,
            parameters: reader
                .read_pointer(5u32)?
                .into_list_reader()?
                .read_struct_children::<Node__Parameter>()?,
    ...
    fn try_from_reader(reader: StructReader) -> Result<Self> {
        let value = Node__Enum {
            enumerants: reader
                .read_pointer(3u32)?
                .into_list_reader()?
                .read_struct_children::<Enumerant>()?,
        };
        Ok(value)
    }
}
    ...
    fn try_from_reader(reader: StructReader) -> Result<Self> {
        let value = Node__Interface {
            methods: reader
                .read_pointer(3u32)?
                .into_list_reader()?
                .read_struct_children::<Method>()?,
            superclasses: reader
                .read_pointer(4u32)?
                .into_list_reader()?
                .read_struct_children::<Superclass>()?,
        };
        Ok(value)
    }
}
    ...
    fn try_from_reader(reader: StructReader) -> Result<Self> {
        let value = Brand {
            scopes: reader
                .read_pointer(0u32)?
                .into_list_reader()?
                .read_struct_children::<Brand__Scope>()?,
        };
        Ok(value)
    }
}
            ...
            0u16 => {
                Self::Bind(
                    reader
                        .read_pointer(0u32)?
                        .into_list_reader()?
                        .read_struct_children::<Brand__Binding>()?,
                )
            }
            1u16 => Self::Inherit,
            _ => Self::UnknownDiscriminant,
    ...
    fn try_from_reader(reader: StructReader) -> Result<Self> {
        let value = Node__SourceInfo {
            ...
            members: reader
                .read_pointer(1u32)?
                .into_list_reader()?
                .read_struct_children::<Node__SourceInfo__Member>()?,
        };
        Ok(value)
    }
}
    ...
    fn try_from_reader(reader: StructReader) -> Result<Self> {
        let value = CodeGeneratorRequest__RequestedFile {
            ...
            imports: reader
                .read_pointer(1u32)?
                .into_list_reader()?
                .read_struct_children::<CodeGeneratorRequest__RequestedFile__Import>()?,
        };
        Ok(value)
    }
}
    ...
    fn try_from_reader(reader: StructReader) -> Result<Self> {
        let value = CodeGeneratorRequest {
            nodes: reader
                .read_pointer(0u32)?
                .into_list_reader()?
                .read_struct_children::<Node>()?,
            requested_files: reader
                .read_pointer(1u32)?
                .into_list_reader()?
                .read_struct_children::<CodeGeneratorRequest__RequestedFile>()?,
            ...
            source_info: reader
                .read_pointer(3u32)?
                .into_list_reader()?
                .read_struct_children::<Node__SourceInfo>()?,
        };
        Ok(value)
    }
}
